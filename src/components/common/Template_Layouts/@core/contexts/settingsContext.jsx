...
export const SettingsProvider = props => {
  ...
  const [_settingsState, _updateSettingsState] = useState(() => {
    const initial = (settingsCookie && JSON.stringify(settingsCookie) !== '{}') 
      ? settingsCookie 
      : updatedInitialSettings;
    
    // Explicit safety fallback
    if (!initial || !initial.mode) {
      console.warn('SettingsProvider: Failed to initialize settings from cookie or initial settings. Using defaults.');
